                ...
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <div class="hero-unit-table">
							...
							<a href = "" name = "" class = "btn btn-success">Electronics</a> 
							<a href = "" name = "" class = "btn btn-primary">Phone</a> 
							<a href = "" name = "" class = "btn btn-info">Computers</a> 
							<a href = "" name = "" class = "btn btn-danger">Fashions</a> 
							<a href = "" name = "" class = "btn btn-primary">Food stuffs</a>
